...
echo [3/5] Creating service directory...
...
echo.
echo 3. Start the Rigbeat service:
echo    net start Rigbeat
echo.
echo 4. Verify metrics at: http://localhost:9182/metrics
echo.
echo 5. Configure Prometheus and import Grafana dashboard
echo.
echo For full documentation, visit:
echo https://github.com/yourusername/pc-hardware-monitor
echo.
pause
